...
public final class PlayerTracker {
	...
	public void onPlayerChangedDimension(PlayerChangedDimensionEvent event) {
		if(ReCubedAPI.validatePlayer(event.player))
			ReCubedAPI.addValueToCategory(LibCategories.DIMENSIONS_CHANGED, event.player.getGameProfile().getName(), event.player.world.provider.getDimensionType().getName(), 1);
	}
